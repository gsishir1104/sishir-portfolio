...
• Supported reporting and database operations for internal business processes.
...
• Analyzed operational datasets to identify trends, patterns, and performance insights.
...
• Developed an AI-powered application that evaluates resumes against job descriptions.

• Generated match scores, keyword analysis, and personalized improvement recommendations.

• Designed and deployed a live web application using GitHub and Vercel.

Job Market Intelligence Dashboard

• Built an interactive analytics dashboard to analyze technology job trends and salary insights.
...
• Built an AI-powered game design application that generates quests, NPCs, bosses, rewards, and storylines.
